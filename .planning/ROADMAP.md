...
**Plans**: 3 plans
Plans:
- [ ] 04-01-PLAN.md — replace legacy onboarding snapshot storage with round-based schema, migration, and auth-safe refactors
...
| 4. Canonical Learner Profile Foundation | 0/3 | Planned | - |
