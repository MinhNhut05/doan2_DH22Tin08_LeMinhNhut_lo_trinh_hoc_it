...
- [ ] **Phase 3: Session Reliability and Vietnamese UX Baseline** - Remove false auth redirects, stale protected-state bugs, and broken Vietnamese copy from critical flows.
...
|-------|----------------|--------|-----------|
| 3. Session Reliability and Vietnamese UX Baseline | 0/TBD | Not started | - |
